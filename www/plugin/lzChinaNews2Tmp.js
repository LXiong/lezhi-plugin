(function() {
    ...
    lz = w.lezhi = {
        ...
        init: function() {
            ...
            BSHARE_FEEDS_OPTIONS = {
				...
				customThumbnail: "",	//the custom imageUrl of the page
				customTitle: "" ,
				...
				if(config.customThumbnail !== ''){
					lezhiParam.push("customThumbnail=" + config.customThumbnail);
				}
            ...
            for (mType in result) {
                ...
                for (i = 0; i < feedLen && (i < col * row || (!pic && i < row)); ++i) {
                    ...
                    if (i < 2) {
                        ...
                        insHtml += '" style="height:100px;display:block;margin-bottom:15px !important;" hidefocus="true">';
						...
						insHtml += '<img class="bshare-logos" src="' + p + '" style="width:88px !important;height:88px !important;float:left;" />'
    ...
    function getRcommConfig() {
        ...
        for (_i = 0; _i < _scriptsLen; _i++) {
            if (/lzChinaNews2(Org|Tmp)?\.js/.test(_scripts[_i].src)) {
        ...
        for (_j = 0; _j < _configLen; _j++) {
            ...
            } else if (/(pic|debug|highlight|showLogo|picBorderRadius|titleBold|fontBold|fontUnderline|linkUnderline)$/.test(_par0)) {
                _par1 = _par1 === "true";
            }
    ...
    function mergeConfig(conf, newconf) {
        ...
        for (o in conf) {
			...
			if(/(htcolor|rtcolor|bdcolor|hvcolor|bgcolor|titleBgColor)/.test(o) && nco != null){
				nco = du(nco);
			}
    ...
    function main() {
        ...
        var pic = config.pic, picSize = config.picSize, position = config.position, fontSize = config.fontSize, type = config.type, promote = config.promote,
            ...
            cssStyles = "#bShareRecommDiv{width:300px;height:400px;z-index:" + (type == "slide" ? 999999 : 99999) + ";overflow:hidden !important;margin:0 !important;padding:0 !important;}"
			+ "#bShareRecommDiv2{width:300px;height:400px;position:relative;margin:0 !important;padding:0 !important;}"
        ...
        // css: .b-recomm-panel
            + ".b-recomm-panel{width:298px;display:none;margin:0 !important;overflow:hidden;padding:5px 0 0 0 !important;float:left;position:relative;";
			if(type == "slide"){
			   cssStyles += (position == "left" ? "left:0px;":"left:25px;");
			}else{
				cssStyles += "left:0px;";
        ...
        cssStyles += "padding:0 4px !important;margin:0 !important;}"
 
       // css: .b-recomm-list li  alice changed text-align:left!important; become text-align:center
            + ".b-recomm-list li{width:289px;padding:0 !important;display:block;text-align:center ;text-indent:0px !important;"
            + "float:left;overflow:hidden;border:0;margin:0px;text-align:left;}"
            
        // css: .b-recomm-list a
        cssStyles += ".b-recomm-list a{font-size:" + fontSize + "px;margin:0 !important;position:relative;"
			+ (fontUnderline ? "text-decoration:underline !important;" : "text-decoration:none !important;")
			+"zoom:1;height:24px;line-height:24px;overflow:hidden;"
        ...
        // css: miscellaneous
            ...
            cssStyles += ".b-recomm-list .feed-title{float:left;width:188px;cursor:pointer;overflow:hidden;word-wrap:break-word; word-break:break-all;padding:0 !important;margin-left:10px !important;font-size:12px;"
            +"}"; //+ "width:" + (picSize + 8) + "px;}";
